                                        ...
                                        <div class="col-sm-10">
                                            <select class="select form-control" id="scheduleday1" name="otpDoctor" required>
                                                ...
                                                <?php foreach ($bacsi as $bs) { ?>
                                                    <option value="<?php echo $bs["ID"]; ?>" <?php if ($bs["ID"] == $l["DoctorID"]) echo "selected"; ?>><?php echo $bs["Name"]; ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group clockpicker" data-align="top" data-autoclose="true">
                                                ...
                                                <input class="form-control" id="starttime" name="txtstartTime" type="text" required value="<?php echo $l["startTime"]; ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group clockpicker" data-align="top" data-autoclose="true">
                                                ...
                                                <input class="form-control" id="endtime" name="txtendTime" type="text" required value="<?php echo $l["endTime"]; ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="select form-control" id="bookavail" name="otpbookAvail" required value="<?php echo $l["bookAvail"]; ?>">
                                                <option value="Có sẵn">
                                                    Có sẵn
                                                </option>
