    ...
    <div class="content container-fluid">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Thêm bác sĩ</h3>
            </div>
            <!-- panel heading end -->
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <form class="form-horizontal" method="post" action="index.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="select form-control" name="optSpeciality" required>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                ...
                                                <input class="form-control" name="txtLicenseNumber" type="number" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                ...
                                                <input class="form-control" name="filehinhanh" type="file" required />
