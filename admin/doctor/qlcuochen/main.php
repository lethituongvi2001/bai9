									...
									?>
										<tbody>
											<tr>
												...
												<td><?php echo $book["ContactAddress"]; ?></td>
												<td><a class="btn btn-warning" href="?action=editBooking&id=<?php echo $book["id"]; ?>"><span class="glyphicon glyphicon-edit"> </span></a></td>
												<td><a class="btn btn-danger" href="?action=deleteBooking&id=<?php echo $book["id"]; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
											</tr>
