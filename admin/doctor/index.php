...
switch ($action) {
    ...
    case "onSubmitBooking":
        ...
        if (isset($_POST['deleteBooking'])) {
            ...
            header("Location: http://127.0.0.1/bai9/admin/doctor/index.php?action=booking");
            exit();
            break;
            ...
            header("Location: http://127.0.0.1/bai9/admin/doctor/index.php?action=editBooking&id=" . $booking_id);
            exit();
            break;
            ...
            if ($_POST['submitType'] == 'add') {
                $result = $book->addBooking(null, $customer_id, $trieu_chung, $dich_vu, $booking_date, $booking_time, $contactName, $contactPhone, $contactAddress, $select_province, $select_district, $select_ward, $distance);
                if ($result) {
                    header("Location: http://127.0.0.1/bai9/admin/doctor/index.php?action=booking");
                    exit();
                    break;
    ...
    case "addBooking":
        ...
        $cities = $common->takeAllProvince();
        // print_r($booking_detail);
        include("qlcuochen/addform.php");
        break;

    case "dangxuat":
        unset($_SESSION['nguoidung']);
        header("Location: http://127.0.0.1/bai9/admin/index.php");
        exit();
        break;
