                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <form class="form-horizontal" method="post" action="index.php" enctype="multipart/form-data">
                                    <input type="hidden" name="tintuc_id" value="<?php echo $tintuc['id']; ?>">
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                <input value="<?php echo $tintuc['title']; ?>" class="form-control" name="title" type="text" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        <label class="control-label col-sm-2 requiredField" for="content">
                                            Nội dung
                                        </label>
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                <textarea style="height: 230px !important;" class="form-control" name="content" type="text" required>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="select form-control" name="post_type" required>
                                                <option value="" selected disabled>Chọn loại bài viết</option>
                                                <?php foreach ($post_type as $c) : ?>
                                                    <option value=<?php echo $c['id'] ?> <?php echo ($tintuc['post_type_id'] == $c['id']) ? 'selected' : ''; ?>>
                                                        <?php echo $c['name'] ?>
                                                    </option>
                                                <?php endforeach ?>
                                            </select>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="custom-file" style="height: 46px;">
                                                <input value="<?php echo $tintuc['FileName'] ?>" name="filehinhanh" onchange="updateLabel()" type="file" class="custom-file-input" id="inputFile" aria-describedby="inputFileAddon">
                                                <label class="custom-file-label" id="inputFileLabel" for="inputFile"><?php echo $tintuc['FileName'] ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="input-group-append col-sm-6">
                                            <span class="input-group-text" id="inputFileAddon">
                                                <img id="previewImg" src="<?php echo $tintuc['AbsolutePath'] ?>" alt="Ảnh" height="90px" width="160px">
                                            </span>
                                        </div>
                                        <div class="col-sm-4">
                                            <?php if ($action == 'them') : ?>
