                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <form class="form-horizontal" method="post" action="index.php" enctype="multipart/form-data">
                                    <input type="hidden" name="khachhang_id" value="<?php echo $khachhang['ID']; ?>">
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                <input value="<?php echo $khachhang['Name']; ?>" class="form-control" name="name" type="text" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group ">
                                                <input value="<?php echo $khachhang['DOB']; ?>" class="form-control" name="dob" type="date" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                <input value="<?php echo $khachhang['Email']; ?>" class="form-control" name="email" type="email" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                <input value="<?php echo $khachhang['PhoneNumber']; ?>" class="form-control" name="phone_number" type="text" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group" data-align="top" data-autoclose="true">
                                                <input value="<?php echo $khachhang['Address']; ?>" class="form-control" name="address" type="text" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="select form-control" id="select_province" name="select_province">
                                                ...
                                                <?php foreach ($cities as $c) : ?>
                                                    <option value="<?php echo $c['matp'] ?>" <?php echo ($khachhang['province_id'] == $c['matp']) ? 'selected' : ''; ?>>
                                                        <?php echo $c['name'] ?>
                                                    </option>
                                                <?php endforeach ?>
                                            </select>
                                        ...
                                        <div class="col-sm-3">
                                            <select class="select form-control" id="select_district" name="select_district">
                                                ...
                                                <?php foreach ($districts as $d) : ?>
                                                    <option value="<?php echo $d['maqh'] ?>" <?php echo ($khachhang['district_id'] == $d['maqh']) ? 'selected' : ''; ?>>
                                                        <?php echo $d['name'] ?>
                                                    </option>
                                                <?php endforeach ?>
                                            </select>
                                        ...
                                        <div class="col-sm-4">
                                            <select class="select form-control" id="select_ward" name="select_ward">
                                                ...
                                                <?php foreach ($wards as $w) : ?>
                                                    <option value="<?php echo $w['xaid'] ?>" <?php echo ($khachhang['ward_id'] == $w['xaid']) ? 'selected' : ''; ?>>
                                                        <?php echo $w['name'] ?>
                                                    </option>
                                                <?php endforeach ?>
                                            </select>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="custom-file" style="height: 46px;">
                                                <input value="<?php echo $khachhang['FileName'] ?>" name="filehinhanh" onchange="updateLabel()" type="file" class="custom-file-input" id="inputFile" aria-describedby="inputFileAddon">
                                                <label class="custom-file-label" id="inputFileLabel" for="inputFile"><?php echo $khachhang['FileName'] ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="input-group-append col-sm-6">
                                            <span class="input-group-text" id="inputFileAddon">
                                                <img id="previewImg" src="<?php echo $khachhang['AbsolutePath'] ?>" alt="Ảnh" height="75px" width="130px">
                                            </span>
                                        </div>
                                        <div class="col-sm-4">
                                            <?php if ($action == 'them') : ?>
